...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (123, NULL, NULL, NULL, NULL, '123456', NULL, NULL);
...
CREATE TABLE `exam_manage`  (
  ...
  `examDate` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '考试日期',
...
) ENGINE = InnoDB AUTO_INCREMENT = 201900022 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '考试管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of exam_manage
-- ----------------------------
INSERT INTO `exam_manage` VALUES (20190001, '2022年上期期末考试', '计算机网络', 1001, '2022-03-21', 120, '2019', '1', '计算机科学与技术', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190002, '2022年上期期末考试', '数据库理论', 1002, '2022-03-07', 90, '2019', '2', '软件工程', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190003, '2022年下期期末考试', '数据结构', 1003, '2022-02-27', 90, '2019', '1', '软件工程', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190005, '2022年上期期末考试', '计算机导论', 1004, '2022-03-14', 90, '2019', '1', '计算机科学与技术', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190006, '2022年上期期末考试', '软件工程', 1005, '2022-03-21', 120, '2019', '1', '计算机科学与技术', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190007, '2020年上期期末考试', '操作系统', 1006, '2022-03-13', 120, '2019', '2', '计算机科学与技术', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190008, '2018年下期期末考试', 'C语言', 1007, '2022-03-13', 120, '2019', '1', '信息工程与大数据', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
INSERT INTO `exam_manage` VALUES (20190009, '2018年上期期末考试', '高等数学', 1008, '2022-03-07', 90, '2019', '1', '信息工程与大数据', '信息学院', 100, '期末考试', '快乐千万条，学习第一条，平时不努力，考试两行泪。');
...
CREATE TABLE `multi_question`  (
  ...
  `level` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '难度等级',
  PRIMARY KEY (`questionId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10039 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '选择题题库表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `paper_manage` VALUES (1001, 1, 10038);
...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '成绩管理表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of score
-- ----------------------------
INSERT INTO `score` VALUES (4, 20190001, 20194084, '计算机网络', NULL, 70, NULL, '2022-04-03');
INSERT INTO `score` VALUES (5, 20190001, 20194084, '计算机网络', NULL, 70, NULL, '2022-04-03');
INSERT INTO `score` VALUES (14, 20190002, 20194084, '数据库理论', NULL, 78, NULL, '2022-04-20');
INSERT INTO `score` VALUES (15, 20190002, 20194084, '数据库理论', NULL, 80, NULL, '2022-04-20');
INSERT INTO `score` VALUES (16, 20190002, 20194084, '数据库理论', NULL, 83, NULL, '2022-04-20');
INSERT INTO `score` VALUES (17, 20190001, 20194001, '计算机网络', NULL, 74, NULL, '2022-04-13');
INSERT INTO `score` VALUES (18, 20190001, 20194001, '计算机网络', NULL, 70, NULL, '2022-04-10');
INSERT INTO `score` VALUES (19, 20190001, 20195003, '计算机网络', NULL, 86, NULL, '2022-04-14');
INSERT INTO `score` VALUES (20, 20190001, 20195007, '计算机网络', NULL, 90, NULL, '2022-04-11');
INSERT INTO `score` VALUES (21, 20190001, 20195007, '计算机网络', NULL, 92, NULL, '2022-04-12');
INSERT INTO `score` VALUES (22, 20190001, 20195008, '计算机网络', NULL, 80, NULL, '2022-04-12');
INSERT INTO `score` VALUES (23, 20190001, 20195003, '计算机网络', NULL, 90, NULL, '2022-04-13');
INSERT INTO `score` VALUES (24, 20190001, 20195008, '计算机网络', NULL, 88, NULL, '2022-04-14');
INSERT INTO `score` VALUES (27, 20190001, 20194084, '计算机网络', NULL, 80, NULL, '2022-04-25');
INSERT INTO `score` VALUES (30, 20190001, 20194084, '计算机网络', NULL, 60, NULL, '2022-04-29');
INSERT INTO `score` VALUES (31, 20190001, 20194084, '计算机网络', NULL, 50, NULL, '2022-09-06');
INSERT INTO `score` VALUES (32, 20190001, 20194084, '计算机网络', NULL, 63, NULL, '2022-08-20');
INSERT INTO `score` VALUES (33, 20190001, 20194084, '计算机网络', NULL, 62, NULL, '2022-08-20');
INSERT INTO `score` VALUES (34, 20190001, 20194084, '计算机网络', NULL, 80, NULL, '2022-10-29');
INSERT INTO `score` VALUES (35, 20190001, 20194084, '计算机网络', NULL, 72, NULL, '2022-10-29');
INSERT INTO `score` VALUES (36, 20190001, 20194084, '计算机网络', NULL, 91, NULL, '2022-10-29');
INSERT INTO `score` VALUES (37, 20190001, 20194084, '计算机网络', NULL, 73, NULL, '2022-11-26');
INSERT INTO `score` VALUES (38, 20190001, 20194084, '计算机网络', NULL, 59, NULL, '2022-12-06');
INSERT INTO `score` VALUES (39, 20190001, 20194084, '计算机网络', NULL, 73, NULL, '2022-12-06');
INSERT INTO `score` VALUES (40, 20190001, 20194084, '计算机网络', NULL, 78, NULL, '2022-12-10');
INSERT INTO `score` VALUES (41, 20190001, 20194084, '计算机网络', NULL, 65, NULL, '2022-12-10');
INSERT INTO `score` VALUES (42, 20190001, 20194084, '计算机网络', NULL, 60, NULL, '2022-12-10');
INSERT INTO `score` VALUES (43, 20190001, 20194084, '计算机网络', NULL, 71, NULL, '2022-12-10');
INSERT INTO `score` VALUES (44, 20190001, 20194084, '计算机网络', NULL, 70, NULL, '2022-12-10');
INSERT INTO `score` VALUES (45, 20190001, 20194084, '计算机网络', NULL, 60, NULL, '2022-12-10');
...
) ENGINE = InnoDB AUTO_INCREMENT = 20195013 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '学生信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES (20194001, '老王', '2019', '计算机科学与技术', '2', '软件工程学院', '13585439532', 'gblw@163.com', '123456', '3412312', '男', '2');
INSERT INTO `student` VALUES (20194084, '大咸鱼', '2019', '计算机科学与技术', '2', '软件工程学院', '13658377857', '13658377857@sina.cn', '123456', '124123124535', '男', '2');
INSERT INTO `student` VALUES (20195003, '张大宝', '2019', '信息工程', '1', '软件工程学院', '15583829425', '15583829425@163.com', '123456', '3242342', '男', '2');
INSERT INTO `student` VALUES (20195007, '翠花', '2019', '网络工程', '1', '软件工程学院', '18734538457', '18734538457@163.com', '123456', '2423423', '女', '2');
INSERT INTO `student` VALUES (20195008, '小王', '2020', '信息工程', '2', '软件工程学院', '15523619564', '15523619564@163.com', '123456', '500234199704022353', '男', '2');
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (20081001, '李四', '软件工程学院', '男', '13598458442', '13598458442@163.com', '123456', '423423283498', '讲师', '1');
